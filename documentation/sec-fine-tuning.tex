...
\section{Fine tuning}\label{sec:finetuning}
 ...
 \begin{warning}
  For the \texttt{fineTuning} feature you should usually use \emph{non}-capturing groups,
  such as \lstinline!(?:...)! and \emph{not} capturing groups, which are
  \lstinline!(...)!
 \end{warning}
...
\subsection{fineTuning arguments}\label{subsec:finetuning:arguments}
 ...
 \announce*{2026-03-15}{fineTuning controls strings allowed between arguments }

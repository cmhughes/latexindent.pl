...
\end{commandshell}
	...
	the separator is empty (see \cref{lst:textWrapOptionsAll}), but you can change it as you see fit.
...
\yamltitle{removeParagraphLineBreaks}*{fields}
	...
	\cref{lst:removeParagraphLineBreaks}.
	...
	within that, on a per-name basis. We will consider examples of each of these in turn.
...
\end{commandshell}
	...
	The remaining code-block types can be customised in analogous ways, although note that \texttt{commands},

...
\subsection{Poly-switches for double back slash}
    With reference to \vref{yaml:lookforaligndelims} \announce{new}{poly-switch for double back slash} 
    ...
    within \texttt{lookForAlignDelims} (\vref{yaml:lookforaligndelims}); we will demonstrate this in what follows.
...
\end{cmhlistings}
    Referencing \cref{lst:dbs-demo}:
      ...
      We explore \texttt{DBSStartsOnOwnLine} ($\ElseStartsOnOwnLine$); starting with 
...
latexindent.pl -m special4.tex -l DBS5.yaml
	...
	\hfill
	\begin{minipage}{.65\linewidth}
		\cmhlistingsfromfile*[style=yaml-LST]*{demonstrations/DBS5.yaml}[MLB-TCB]{\texttt{DBS5.yaml}}{lst:DBS5}
	\end{minipage}
...
latexindent.pl -m mycommand2.tex -l DBS7.yaml
	...
	\hfill
	\begin{minipage}{.65\linewidth}
		\cmhlistingsfromfile*[style=yaml-LST]*{demonstrations/DBS6.yaml}[MLB-TCB]{\texttt{DBS6.yaml}}{lst:DBS6}
	\end{minipage}
	...
	\hfill
	\begin{minipage}{.65\linewidth}
		\cmhlistingsfromfile*[style=yaml-LST]*{demonstrations/DBS7.yaml}[MLB-TCB]{\texttt{DBS7.yaml}}{lst:DBS7}
	\end{minipage}

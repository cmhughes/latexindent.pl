...
\yamltitle{removeSentenceLineBreaks}{0|1}
	...
	internal line breaks as \texttt{removeSentenceLineBreaks} is set to \texttt{1}.
...
\end{commandshell}
	...
	field.%
	\announce{new}{fine tuning the betterFullStop} You can also seek
	...
	it does not accommodate the specifications above. For example, using the following command
	\begin{commandshell}
...
\subsection{Poly-switches}\label{sec:poly-switches}
	...
	\begin{itemize}[font=\bfseries]
		...
		\item[4] \emph{add blank line mode}%
		      \announce{new}{blank line poly-switch}; a blank line will
...
\end{commandshell}
	...
	Let's now change%
	\announce{new}{demonstration of new blank line poly-switch} each of
...
\subsection{Poly-switches for double back slash}\label{subsec:dbs}
	...
	\announce{new}{poly-switch for double back slash} you can

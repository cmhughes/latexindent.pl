...
\subsubsection{Text wrap: overview}
 ...
 \begin{enumerate}
  ...
  \item about trailing comments within text wrap blocks:
        ...
        \end{enumerate}
  \item trailing comments can receive text wrapping \announce{new}{text wrap trailing
        comments}; examples are shown in \cref{subsubsec:tw:comments} and
...
\subsubsection{Text wrap: wrapping comments}\label{subsubsec:tw:comments}
 ...
 \announce{new}{text wrap trailing comments}; we demonstrate this with examples, see also
 \cref{subsubsec:ospl:tw:comments}. \index{comments!text wrap} \index{text wrap!comments}

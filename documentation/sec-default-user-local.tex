...
latexindent.pl tabular1.tex   
 ...
 \begin{itemize}
  ...
  \item \announce{new}{alignContentAfterDoubleBackSlash feature}
  ...
  \item \announce{new}{spacesAfterDoubleBackSlash feature} spacesAfterDoubleBackSlash
        optionally specifies the number (integer $\geq$ 0) of spaces to be placed
        \emph{after} the double back slash \emph{when alignContentAfterDoubleBackSlash is
        active}; demonstrated in \cref{sec:alignContentAfterDoubleBackSlash}.
 \end{itemize}
...
\subsubsection{lookForAlignDelims: alignContentAfterDoubleBackSlash}\label{sec:alignContentAfterDoubleBackSlash}
 You can instruct \texttt{latexindent} to align \announce{new}{align content after double
 back slash} content after the double back slash. See also \vref{subsec:dbs}.
...
\end{commandshell}
 ...
 \announce{new}{specify number of spaces after double back slash when aligning content
 after double back slash}

...
\yamltitle{indentAfterItems}*{fields}
 ...
 field, discussed in \vref{subsec:finetuning:itemsRegex}.\announce{NEW}{itemsRegex controls item}
...
\end{commandshell}
 ...
 \begin{cmhtcbraster}[ raster left skip=-3.5cm,]
  ...
  \cmhlistingsfromfile*[style=yaml-LST]{demonstrations/special-nested1.yaml}[yaml-TCB]{\texttt{special-body1.yaml}}{lst:special-nested1}
 \end{cmhtcbraster}

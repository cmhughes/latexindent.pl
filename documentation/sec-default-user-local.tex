...
\yamltitle{specialBeginEnd}*{fields}\label{yaml:specialBeginEnd}
	...
	\announce{NEW}*{specialBeginEnd} in \texttt{specialBeginEnd} are, in their default state, focused on math mode begin and end statements, but
	...
	There are%
	\announce{NEW}{specialBeforeCommand} examples in which it is advantageous to search for \texttt{specialBeginEnd} fields \emph{before}
	...
	\cmhlistingsfromfile*{demonstrations/specialLR.tex}{\texttt{specialLR.tex}}{lst:specialbefore}
...
\yamltitle{maximumIndentation}*{horizontal space}
	...
	\announce{NEW}{maximumIndentation}

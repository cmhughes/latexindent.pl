...
latexindent.pl tabular1.tex   
 ...
 the entry for \texttt{tabular} is advanced. \announce{NEW}{fineTuning controls defaults for advanced form of lookForAlignDelims} 
 The default values for the advanced form are controlled in \texttt{fineTuning}, see \vref{sec:finetuning}. When using the advanced form, each field should receive at
...
\yamltitle{indentAfterItems}*{fields}
 ...
 for example) then you can put adjust \texttt{itemRegEx} in the 
 \texttt{fineTuning} field, discussed in \vref{sec:finetuning}.
...
latexindent.pl special1.tex -o=+-default
 ...
 Now consider the YAML file shown in
...
\yamltitle{indentAfterHeadings}*{fields}
 ...
 switch them on by changing \texttt{lookForThis} from 0 to 1. The

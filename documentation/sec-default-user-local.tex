   ...
   ...
	...
	\begin{itemize}
		...
		\item \texttt{spacesBeforeDoubleBackSlash}: optionally,%
		      \announce{NEW}*{update to spacesBeforeDoubleBackSlash} specifies the number (integer $\geq$ 0) of spaces to be inserted
		...
		\item \announce{NEW}{justification}\texttt{justification}: optionally specifies the justification of each cell as either \emph{left}

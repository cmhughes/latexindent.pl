...
\end{filecontents}
  \end{lstlisting}                                                                                                                                                                                                                                                                                                                                                                      \\
    ...
    We will refer to these code blocks in what follows. \announce{new}{fine tuning of code blocks} Note that the fine tuning 
    of the definition of the code blocks detailed in \label{tab:code-blocks} is discussed in \vref{sec:finetuning}.

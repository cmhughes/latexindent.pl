...
latexindent.pl tabular1.tex   
 ...
 the entry for \texttt{tabular} is advanced. \announce{NEW}{fineTuning controls defaults
 for advanced form of lookForAlignDelims} The default values for the advanced form are
 controlled in \texttt{fineTuning}, see \vref{subsec:finetuning:lookForAlignDelims}. When
 using the advanced form, each field should receive at least 1 sub-field, and \emph{can}
...
\yamltitle{indentAfterItems}*{fields}
 ...
 field, discussed in \vref{subsec:finetuning:itemsRegex}.\announce{NEW}{itemsRegex
 controls item}
...
\yamltitle{specialBeginEnd}*{fields}\label{yaml:specialBeginEnd}
 ...
 \announce{NEW}{specialBeginEnd specified as list}%
...
\end{commandshell}
 ...
 \announce{NEW}{specialBeginEnd nested demonstration}
 \end{example}

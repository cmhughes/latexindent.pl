...
latexindent.pl -l matrix1.tex 
	...
	\hfill
	\begin{minipage}{.45\textwidth}
		\cmhlistingsfromfile[columns=fixed]{demonstrations/align-block-default.tex}{\texttt{matrix1.tex} default output}{lst:alignmentmarkup-default}
	\end{minipage}%

...
\end{commandshell}
 ...
 Referencing \vref{lst:specialBeginEnd} we see that \announce{new}{specialBeginEnd body
 field} each of the \texttt{specialBeginEnd} fields can \emph{optionally} accept the

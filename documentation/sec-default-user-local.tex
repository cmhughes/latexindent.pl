...
lookForAlignDelims:
   ...
   ...
	...
	\begin{itemize}
		...
		\item \announce{NEW}{align final double back slash}{alignFinalDoubleBackSlash} optionally specifies if the
		      \emph{final} double back slash should be used for alignment (default: 0);
		\item \announce{NEW}{don't measure feature}{dontMeasure} optionally specifies if
		      user-specified cells, rows or the largest entries should \emph{not} be
		      measured (default: 0);
		\item \announce{NEW}{delimiter RegEx feature}{delimiterRegEx} optionally specifies the pattern
		      matching to be used for the alignment delimeter (default: \lstinline3 '(?<!\\)(&)'3);
		\item \announce{NEW}{delimiter justification}{delimiterJustification} optionally specifies the justification
...
\subsection{lookForAlignDelims: the dontMeasure feature}\label{sec:dontMeasure}
	The%
	\announce{NEW}{don't measure feature} \texttt{lookForAlignDelims}
...
\subsection{lookForAlignDelims: the delimiterRegEx and delimiterJustification feature}\label{sec:delimiter-reg-ex}
	...
	\announce{new}{delimiterRegEx feature} will, by
...
\end{commandshell}
	...
	the delimiter to be either \lstinline!#! or \lstinline!\>!,

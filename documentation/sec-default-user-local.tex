...
\yamltitle{verbatimEnvironments}*{fields}
	...
	\begin{wrapfigure}[14]{r}[0pt]{6cm}
		\cmhlistingsfromfile[firstnumber=64,linerange={64-66},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{\texttt{verbatimEnvironments}}{lst:verbatimEnvironments}

		\vspace{.2cm}
		\cmhlistingsfromfile[firstnumber=69,linerange={69-71},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{\texttt{verbatimCommands}}{lst:verbatimCommands}
	\end{wrapfigure}
...
\yamltitle{noIndentBlock}*{fields}
	...
	\begin{wrapfigure}[8]{r}[0pt]{6cm}
		\cmhlistingsfromfile[firstnumber=77,linerange={77-79},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{\texttt{noIndentBlock}}{lst:noIndentBlock}
	\end{wrapfigure}
...
\yamltitle{removeTrailingWhitespace}*{fields}\label{yaml:removeTrailingWhitespace}
	...
	\begin{wrapfigure}[12]{r}[0pt]{6cm}
		\cmhlistingsfromfile[firstnumber=82,linerange={82-84},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{removeTrailingWhitespace}{lst:removeTrailingWhitespace}

		\vspace{.2cm}
		\cmhlistingsfromfile[firstnumber=88,linerange={88-90},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{\texttt{fileContentsEnvironments}}{lst:fileContentsEnvironments}
	\end{wrapfigure}
...
\yamltitle{lookForPreamble}*{fields}
	...
	\begin{wrapfigure}[8]{r}[0pt]{5cm}
		\cmhlistingsfromfile[firstnumber=96,linerange={96-100},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{lookForPreamble}{lst:lookForPreamble}
	\end{wrapfigure}
...
lookForAlignDelims:
   ...
   ...
	...
	\cmhlistingsfromfile[firstnumber=114,linerange={114-121},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[yaml-TCB]{\texttt{lookForAlignDelims} (advanced)}{lst:aligndelims:advanced}
...
\yamltitle{indentAfterItems}*{fields}
	\begin{wrapfigure}[5]{r}[0pt]{7cm}
		\cmhlistingsfromfile[firstnumber=148,linerange={148-151},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{\texttt{indentAfterItems}}{lst:indentafteritems}
	\end{wrapfigure}
...
\yamltitle{itemNames}*{fields}
	\begin{wrapfigure}[5]{r}[0pt]{5cm}
		\cmhlistingsfromfile[firstnumber=157,linerange={157-159},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{\texttt{itemNames}}{lst:itemNames}
	\end{wrapfigure}
...
\yamltitle{specialBeginEnd}*{fields}
	...
	\cmhlistingsfromfile[firstnumber=163,linerange={163-175},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{\texttt{specialBeginEnd}}{lst:specialBeginEnd}
...
\yamltitle{indentAfterHeadings}*{fields}
	\begin{wrapfigure}[17]{r}[0pt]{8cm}
		\cmhlistingsfromfile[firstnumber=185,linerange={185-194},style=yaml-LST,numbers=left]{../defaultSettings.yaml}[width=.8\linewidth,before=\centering,yaml-TCB]{\texttt{indentAfterHeadings}}{lst:indentAfterHeadings}
	\end{wrapfigure}

...
latexindent.pl -s multiple-sentences8.tex -o=+-mod1.tex -l=sentence-wrap2.yaml -m
 ...
 \begin{cmhtcbraster}
  ...
  \cmhlistingsfromfile*[style=yaml-LST]{demonstrations/sentence-wrap2.yaml}[MLB-TCB]{\texttt{sentence-wrap2.yaml}}{lst:sentence-wrap2}
 \end{cmhtcbraster}
...
latexindent.pl -s multiple-sentences8.tex -o=+-mod2.tex -l=sentence-wrap3.yaml -m
 ...
 \begin{cmhtcbraster}
  ...
  \cmhlistingsfromfile*[style=yaml-LST]{demonstrations/sentence-wrap3.yaml}[MLB-TCB]{\texttt{sentence-wrap3.yaml}}{lst:sentence-wrap3}
 \end{cmhtcbraster}

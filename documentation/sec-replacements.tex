...
\end{commandshell}
	...
	\begin{example}
		...
		an example that contains a verbatim code block, \cref{lst:verb1}; we will use the settings in \cref{lst:verb1-yaml}.
...
\end{commandshell}
	...
	\begin{enumerate}
		\item in \cref{lst:verb1-mod1} indentation has been performed, and that the replacements
		      specified in \cref{lst:verb1-yaml} have been performed, even within the verbatim code
		      block;

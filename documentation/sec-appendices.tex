...
latexindent.exe -t myfile.tex
 \end{dosprompt}
	...
	\subsection{The GCString switch}\label{subsec:the-GCString}
		...
		for your language, then you may with to use the \texttt{Unicode::GCString} module \announce{new}{Unicode::GCString}.
...
echo %path%
	...
	\section{Batches of files}\label{sec:batches}
	 ...
	 You can \announce{new}{batches of files details} instruct \texttt{latexindent.pl} to
	 operate on multiple files. For example, the following calls are all valid
	 \begin{commandshell}

...
\section{The --lines switch}\label{sec:line-switch}
 ...
 \announce{new}{line switch demonstration} can
...
\end{commandshell}
	 ...
	 \cmhlistingsfromfile*[numbers=left,numberstyle=\color{blue},]*{demonstrations/myfile-mod2.tex}[tex-TCB]{\texttt{myfile-mod2.tex}}{lst:myfile-mod2}
...
\end{commandshell}
	 ...
	 \cmhlistingsfromfile*[numbers=left,numberstyle=\color{blue},]*{demonstrations/myfile-mod3.tex}[tex-TCB]{\texttt{myfile-mod3.tex}}{lst:myfile-mod3}
...
\end{commandshell}
	 ...
	 \cmhlistingsfromfile*[numbers=left,numberstyle=\color{blue},]*{demonstrations/myfile-mod4.tex}[tex-TCB]{\texttt{myfile-mod4.tex}}{lst:myfile-mod4}
...
\end{commandshell}
	 ...
	 \cmhlistingsfromfile*[numbers=left,numberstyle=\color{blue},]*{demonstrations/myfile-mod5.tex}[tex-TCB]{\texttt{myfile-mod5.tex}}{lst:myfile-mod5}
...
latexindent.pl --lines 1-4,8,11-12 myfile.tex -o=+-mod6
   \end{commandshell}
	 ...
	 \cmhlistingsfromfile*[numbers=left,numberstyle=\color{blue},]*{demonstrations/myfile-mod6.tex}[tex-TCB]{\texttt{myfile-mod6.tex}}{lst:myfile-mod6}
 \end{example}
...
latexindent.pl --lines !y-3 myfile.tex 
 ...
 \begin{example}
	 ...
	 \cmhlistingsfromfile*[numbers=left,numberstyle=\color{blue},]*{demonstrations/myfile1.tex}[tex-TCB]{\texttt{myfile1.tex}}{lst:myfile1}
...
latexindent.pl --lines 6 myfile1.tex -o=+-mod1 -m -l env-mlb2,env-mlb7,env-mlb8 -o=+-mod1
	 ...
	 \cmhlistingsfromfile*[numbers=left,numberstyle=\color{blue},]*{demonstrations/myfile1-mod1.tex}[tex-TCB]{\texttt{myfile1-mod1.tex}}{lst:myfile1-mod1}
 \end{example}

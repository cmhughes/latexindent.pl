...
\end{commandshell}
	You can%
	\announce{new}{-k,-check switch} instruct
...
\end{commandshell}
	\announce{new}{-kv, -checkv: check verbose switch} The \texttt{check verbose} switch is
...
\end{commandshell}
	\announce{new}{-n, -lines switch} The \texttt{lines} switch instructs

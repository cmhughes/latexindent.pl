...
latexindent.pl myfile.tex
	...
	\texttt{myfile.tex} will			not be changed by \texttt{latexindent.pl}
...
latexindent.pl -replacement myfile.tex
      \end{commandshell}
	You can%
	\announce{new}{replacement mode switch} call
...
latexindent.pl -replacementrespectverb myfile.tex
      \end{commandshell}
	You can%
	\announce{new}{replacement mode switch, respecting verbatim} instruct
...
latexindent.pl -onlyreplacement myfile.tex
      \end{commandshell}
	You can%
	\announce{new}{replacement (only) mode switch} instruct

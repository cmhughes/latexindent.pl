...
\section{How to use the script}
 ...
 Linux and Mac users; \texttt{latexindent.exe} ships as part of the \TeX Live for Windows users. 
 These files are also available from github
 ...
 MiKTeX users on Windows may like to see \cite{miktex-guide} for details of how 
 to use \texttt{latexindent.exe} without a Perl installation.
 \index{MiKTeX}

...
latexindent.pl -replacement myfile.tex
      \end{commandshell}
    You can \announce{new}{replacement mode switch} call \texttt{latexindent.pl} with the \texttt{-r} switch
    to instruct it to perform replacements/substitutions on your file; full details and examples are given in
...
latexindent.pl -onlyreplacement myfile.tex
      \end{commandshell}
    You can \announce{new}{replacement (only) mode switch} instruct \texttt{latexindent.pl} to skip all of its other
    indentation operations and \emph{only} perform replacements/substitutions by using the \texttt{-rr} switch; 

...
\subsection{switches via yaml}
 ...
 \announce{NEW}{switchesViaYAML details}For some of the switches, you can specify them by
 the YAML interface; the defaults are shown in \cref{lst:switchesViaYaml}.

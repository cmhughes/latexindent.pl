...
\end{commandshell}
	...
	You can \announce{new}{batches of files demonstration} instruct \texttt{latexindent.pl}
...
\flagbox{-wd, --overwriteIfDifferent}
	...
	\announce{new}{overwriteIfDifferent switch}
	\begin{commandshell}
...
\end{commandshell}
	\announce{new}{GCString switch} instructs \texttt{latexindent.pl} to load the

...
latexindent.pl myfile.tex
	...
	\texttt{myfile.tex} will		  not be changed by \texttt{latexindent.pl} in any
	way using this command.
...
latexindent.pl -replacementrespectverb myfile.tex
      \end{commandshell}
	You can%
	\announce{new}{replacement mode switch, respecting verbatim} instructs
...
latexindent.pl -onlyreplacement myfile.tex
      \end{commandshell}
	You can%
	\announce{new}{replacement (only) mode switch} instructs

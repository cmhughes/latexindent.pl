...
\end{cmhlistings}
	...
	\subsection{Module installer script}\label{sec:module-installer}
		...
		install any missing \texttt{perl} modules
...
latexindent.exe -t myfile.tex
 \end{dosprompt}
	...
	\section{Updating the path variable}\label{sec:updating-path}
	 ...
	 update the \texttt{path} variables.
	 Thank you to \cite{jasjuang} for this feature. If you're on a Linux or Mac
	 machine, then you'll want \texttt{CMakeLists.txt} from \cite{latexindent-home}.

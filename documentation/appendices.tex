...
Active code page: 936
    \end{dosprompt}
	 ...
	 \cmhlistingsfromfile*{demonstrations/encoding1.yaml}[yaml-TCB]{\texttt{encoding}
		 demonstration for \texttt{indentconfig.yaml}}{lst:indentconfig-encoding1}
...
\end{commandshell}
	 ...
	 \cmhlistingsfromfile{demonstrations/obsolete.yaml}[yaml-obsolete]{Obsolete YAML fields
		 from Version 3.0}{lst:obsoleteYaml}

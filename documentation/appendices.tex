...
If you use \texttt{latexindent.pl} on a dos-based Windows file on Linux \announce{new}{dos2unix linebreaks}
then you may find that trailing horizontal space is not removed as you hope. 

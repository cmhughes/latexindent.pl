...
\subsubsection{The remaining code blocks}
	...
	\paragraph{keyEqualsValuesBracesBrackets}
		...
		\begin{itemize}
			...
			\item then at least one set of curly braces or square brackets (comments and line breaks
			      allowed throughout).
		\end{itemize}
        See the \texttt{keyEqualsValuesBracesBrackets: follow}  and \texttt{keyEqualsValuesBracesBrackets: name} fields of the fine 
        tuning section in \vref{lst:fineTuning}\announce{new}{fine tuning: keyEqualsValuesBracesBrackets}
	...
	\paragraph{namedGroupingBracesBrackets}
        ...
        tuning section in \vref{lst:fineTuning}\announce{new}{fine tuning: namedGroupingBracesBrackets}
	...
	\paragraph{UnNamedGroupingBracesBrackets} occur in a variety of situations; specifically, we define
		...
		\begin{itemize}
			...
			\item then at least one set of curly braces or square brackets (comments and line breaks
			      allowed throughout).
		\end{itemize}
        See the \texttt{UnNamedGroupingBracesBrackets: follow} field of the fine 
        tuning section in \vref{lst:fineTuning}\announce{new}{fine tuning: namedGroupingBracesBrackets}

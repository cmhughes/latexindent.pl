...
\subsection{localSettings.yaml and friends}\label{sec:localsettings}
	...
	\announce{NEW}*{-l switch: localSettings and friends} example, if you use the following
	command
...
\end{commandshell}
	...
	otherwise in the current working directory. You do not need to have all of the above files, usually just one 
    will be sufficient. In what follows, whenever we refer to

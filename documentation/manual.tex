...
\begin{itemize}
 ...
 entirely by \lstinline!onlyOneBackUp!.
  ...
  \item[\verbitem{backupFilesStoredIn}]\lstinline!./!

    The backup files may be stored in a directory other than the current working 
    directory. This field can contain an absolute path, such as
\lstinline!backupFilesStoredIn: /home/cmhughes/Desktop! or it could be a relative 
path, such as \lstinline!backupFilesStoredIn: ../!

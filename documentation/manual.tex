...
\item[\verbitem{fileExtensionPreference}] \lstinline!latexindent.pl! can be called to 
  ...
  \begin{cmhlistings}{\lstinline!fileExtensionPreference!}{lst:fileExtensionPreference}
...
means that the script will first look for \lstinline!myfile.tex! and then \lstinline!myfile.sty!, etc.
	\begin{warning}

...
the future!); thank you very much to the people detailed in \fixthis{need new bibliograph}
...
\lstinline!latexindent.pl! ships as part of the TeXLive distribution for
Linux and Mac users; \lstinline!latexindent.exe! ships as part of the TeXLive
and MiKTeX distributions for Windows users. These files are also available
...
\nocite{*}
\printbibliography[heading=bibintoc,title={References},type=online]

...
then noAdditionalIndent/indentRules will be ignored for these code blocks. 
...
The \fi command knows to insert a space, so as to give, for example, \fi text, and avoid things such as \fitext

...
This is the first example of a field in \texttt{defaultSettings.yaml} that has more than one line, and 
contains fields which each have their own setting as shown in \cref{lst:lookForPreamble}.
...
\begin{yaml}[numbers=none]{\texttt{lookForAlignDelims} (basic)}{lst:aligndelims:basic}
lookForAlignDelims:
   tabular: 1
   tabularx: 1
   longtable: 1

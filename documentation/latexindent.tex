...
\lstdefinestyle{verbatimEnvironments}{
	style=yaml-LST,
	firstnumber=87,linerange={87-89},numbers=left
}

\lstdefinestyle{verbatimCommands}{
	style=yaml-LST,
	firstnumber=92,linerange={92-94},numbers=left
}

\lstdefinestyle{noIndentBlock}{
	style=yaml-LST,
	firstnumber=100,linerange={100-102},numbers=left
}

\lstdefinestyle{removeTrailingWhitespace}{
	style=yaml-LST,
	firstnumber=105,linerange={105-107},numbers=left
}

\lstdefinestyle{fileContentsEnvironments}{
	style=yaml-LST,
	firstnumber=111,linerange={111-113},numbers=left
}

\lstdefinestyle{lookForPreamble}{
	style=yaml-LST,
	firstnumber=119,linerange={119-123},numbers=left
}

\lstdefinestyle{indentAfterItems}{
	style=yaml-LST,
	firstnumber=171,linerange={171-174},numbers=left
}

\lstdefinestyle{itemNames}{
	style=yaml-LST,
	firstnumber=180,linerange={180-182},numbers=left
}

\lstdefinestyle{specialBeginEnd}{
	style=yaml-LST,
	firstnumber=186,linerange={186-198},numbers=left
}

\lstdefinestyle{indentAfterHeadings}{
	style=yaml-LST,
	firstnumber=208,linerange={208-217},numbers=left
}

\lstdefinestyle{noAdditionalIndentGlobalEnv}{
	style=yaml-LST,
	firstnumber=263,linerange={263-264},numbers=left
}

\lstdefinestyle{noAdditionalIndentGlobal}{
	style=yaml-LST,
	firstnumber=263,linerange={263-275},numbers=left
}

\lstdefinestyle{indentRulesGlobalEnv}{
	style=yaml-LST,
	firstnumber=279,linerange={279-280},numbers=left
}

\lstdefinestyle{indentRulesGlobal}{
	style=yaml-LST,
	firstnumber=279,linerange={279-291},numbers=left
}

\lstdefinestyle{commandCodeBlocks}{
	style=yaml-LST,
	firstnumber=294,linerange={294-302},numbers=left
}

\lstdefinestyle{modifylinebreaks}{
	style=yaml-LST,
	firstnumber=372,linerange={372-374},numbers=left
}

\lstdefinestyle{textWrapOptions}{
	style=yaml-LST,
	firstnumber=375,linerange={375-376},numbers=left
}

\lstdefinestyle{textWrapOptionsAll}{
	style=yaml-LST,
	firstnumber=375,linerange={375-377},numbers=left
}

\lstdefinestyle{removeParagraphLineBreaks}{
	style=yaml-LST,
	firstnumber=378,linerange={378-387},numbers=left
}

\lstdefinestyle{modifylinebreaksEnv}{
	style=yaml-LST,
	firstnumber=388,linerange={388-397},numbers=left
}

...
\lstdefinestyle{logFilePreferences}{
	style=yaml-LST,
	firstnumber=88,linerange={88-94},
	numbers=left,
}

\lstdefinestyle{verbatimEnvironments}{
	style=yaml-LST,
	firstnumber=98,linerange={98-101},
	numbers=left,
}
...
\lstdefinestyle{noIndentBlock}{
	style=yaml-LST,
	firstnumber=111,linerange={111-113},
	numbers=left,
}

\lstdefinestyle{removeTrailingWhitespace}{
	style=yaml-LST,
	firstnumber=142,linerange={142-144},
	numbers=left,
}
...
\lstdefinestyle{lookForPreamble}{
	style=yaml-LST,
	firstnumber=125,linerange={125-129},
	numbers=left,
}

\lstdefinestyle{lookForAlignDelims}{
	style=yaml-LST,
	firstnumber=147,linerange={147-163},
	numbers=left,
}

\lstdefinestyle{indentAfterItems}{
	style=yaml-LST,
	firstnumber=220,linerange={220-224},
	numbers=left,
}

\lstdefinestyle{itemNames}{
	style=yaml-LST,
	firstnumber=230,linerange={230-232},
	numbers=left,
}

\lstdefinestyle{specialBeginEnd}{
	style=yaml-LST,
	firstnumber=236,linerange={236-249},
	numbers=left,
}

\lstdefinestyle{indentAfterHeadings}{
	style=yaml-LST,
	firstnumber=259,linerange={259-268},
	numbers=left,
}

\lstdefinestyle{noAdditionalIndentGlobalEnv}{
	style=yaml-LST,
	firstnumber=317,linerange={317-318},
	numbers=left,
}

\lstdefinestyle{noAdditionalIndentGlobal}{
	style=yaml-LST,
	firstnumber=317,linerange={317-329},
	numbers=left,
}
...
\lstdefinestyle{commandCodeBlocks}{
	style=yaml-LST,
	firstnumber=348,linerange={348-363},
	numbers=left,
}
...
\lstdefinestyle{textWrapOptionsAll}{
	style=yaml-LST,
	firstnumber=502,linerange={502-519},
	numbers=left,
}

\lstdefinestyle{removeParagraphLineBreaks}{
	style=yaml-LST,
	firstnumber=520,linerange={520-534},
	numbers=left,
}

\lstdefinestyle{paragraphsStopAt}{
	style=yaml-LST,
	firstnumber=535,linerange={535-544},
	numbers=left,
}
...
\lstdefinestyle{modifylinebreaksEnv}{
	style=yaml-LST,
	firstnumber=545,linerange={545-554},
	numbers=left,
}

\lstdefinestyle{replacements}{
	style=yaml-LST,
	firstnumber=606,linerange={606-614},
	numbers=left,
}

\lstdefinestyle{fineTuning}{
	style=yaml-LST,
	firstnumber=617,linerange={617-640},
	numbers=left,
}

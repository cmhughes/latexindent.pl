...
\lstdefinestyle{fileExtensionPreference}{
 style=yaml-LST,
 firstnumber=31,linerange={31-35},
 numbers=left,
}

\lstdefinestyle{logFilePreferences}{
 style=yaml-LST,
 firstnumber=523,linerange={523-535},
 numbers=left,
}

\lstdefinestyle{verbatimEnvironments}{
 style=yaml-LST,
 firstnumber=68,linerange={68-71},
 numbers=left,
}

\lstdefinestyle{verbatimCommands}{
 style=yaml-LST,
 firstnumber=74,linerange={74-76},
 numbers=left,
}

\lstdefinestyle{noIndentBlock}{
 style=yaml-LST,
 firstnumber=81,linerange={81-83},
 numbers=left,
}
...
\lstdefinestyle{fileContentsEnvironments}{
 style=yaml-LST,
 firstnumber=87,linerange={87-89},
 numbers=left,
}

\lstdefinestyle{lookForPreamble}{
 style=yaml-LST,
 firstnumber=95,linerange={95-100},
 numbers=left,
}

\lstdefinestyle{lookForAlignDelims}{
 style=yaml-LST,
 firstnumber=111,linerange={111-114},
 numbers=left,
}

\lstdefinestyle{indentAfterItems}{
 style=yaml-LST,
 firstnumber=179,linerange={179-186},
 numbers=left,
}

\lstdefinestyle{specialBeginEnd}{
 style=yaml-LST,
 firstnumber=189,linerange={189-201},
 numbers=left,
}

\lstdefinestyle{indentAfterHeadings}{
 style=yaml-LST,
 firstnumber=211,linerange={211-220},
 numbers=left,
}

\lstdefinestyle{noAdditionalIndentGlobalEnv}{
 style=yaml-LST,
 firstnumber=260,linerange={260-261},
 numbers=left,
}

\lstdefinestyle{noAdditionalIndentGlobal}{
 style=yaml-LST,
 firstnumber=260,linerange={260-272},
 numbers=left,
}

\lstdefinestyle{indentRulesGlobalEnv}{
 style=yaml-LST,
 firstnumber=275,linerange={275-276},
 numbers=left,
}

\lstdefinestyle{indentRulesGlobal}{
 style=yaml-LST,
 firstnumber=275,linerange={275-287},
 numbers=left,
}

\lstdefinestyle{modifylinebreaks}{
 style=yaml-LST,
 firstnumber=292,linerange={292-294},
 numbers=left,
}

\lstdefinestyle{textWrapOptions}{
 style=yaml-LST,
 firstnumber=328,linerange={328-329},
 numbers=left,
}

\lstdefinestyle{textWrapOptionsAll}{
 style=yaml-LST,
 firstnumber=328,linerange={328-353},
 numbers=left,
}

\lstdefinestyle{oneSentencePerLine}{
 style=yaml-LST,
 firstnumber=298,linerange={298-324},
 numbers=left,
}

\lstdefinestyle{sentencesFollow}{
 style=yaml-LST,
 firstnumber=304,linerange={304-312},
 numbers=left,
}

\lstdefinestyle{sentencesBeginWith}{
 style=yaml-LST,
 firstnumber=313,linerange={313-316},
 numbers=left,
}

\lstdefinestyle{sentencesEndWith}{
 style=yaml-LST,
 firstnumber=317,linerange={317-322},
 numbers=left,
}

\lstdefinestyle{sentencesDoNOTcontain}{
 style=yaml-LST,
 firstnumber=323,linerange={323-324},
 numbers=left,
}

\lstdefinestyle{modifylinebreaksEnv}{
 style=yaml-LST,
 firstnumber=363,linerange={363-372},
 numbers=left,
}

\lstdefinestyle{replacements}{
 style=yaml-LST,
 firstnumber=422,linerange={422-427},
 numbers=left,
}

\lstdefinestyle{switchesViaYaml}{
 style=yaml-LST,
 firstnumber=510,linerange={510-520},
 numbers=left,
}

\lstdefinestyle{fineTuning}{
 style=yaml-LST,
 firstnumber=430,linerange={430-505},
 numbers=left,
}

...
\lstdefinestyle{logFilePreferences}{
 style=yaml-LST,
 firstnumber=68,linerange={68-82},
 numbers=left,
}

\lstdefinestyle{verbatimEnvironments}{
 style=yaml-LST,
 firstnumber=85,linerange={85-88},
 numbers=left,
}

\lstdefinestyle{verbatimCommands}{
 style=yaml-LST,
 firstnumber=91,linerange={91-93},
 numbers=left,
}

\lstdefinestyle{noIndentBlock}{
 style=yaml-LST,
 firstnumber=98,linerange={98-100},
 numbers=left,
}
...
\lstdefinestyle{fileContentsEnvironments}{
 style=yaml-LST,
 firstnumber=104,linerange={104-106},
 numbers=left,
}

\lstdefinestyle{lookForPreamble}{
 style=yaml-LST,
 firstnumber=112,linerange={112-117},
 numbers=left,
}

\lstdefinestyle{lookForAlignDelims}{
 style=yaml-LST,
 firstnumber=128,linerange={128-131},
 numbers=left,
}

\lstdefinestyle{indentAfterItems}{
 style=yaml-LST,
 firstnumber=196,linerange={196-203},
 numbers=left,
}

\lstdefinestyle{specialBeginEnd}{
 style=yaml-LST,
 firstnumber=206,linerange={206-218},
 numbers=left,
}

\lstdefinestyle{indentAfterHeadings}{
 style=yaml-LST,
 firstnumber=228,linerange={228-237},
 numbers=left,
}

\lstdefinestyle{noAdditionalIndentGlobalEnv}{
 style=yaml-LST,
 firstnumber=277,linerange={277-278},
 numbers=left,
}

\lstdefinestyle{noAdditionalIndentGlobal}{
 style=yaml-LST,
 firstnumber=277,linerange={277-289},
 numbers=left,
}

\lstdefinestyle{indentRulesGlobalEnv}{
 style=yaml-LST,
 firstnumber=292,linerange={292-293},
 numbers=left,
}

\lstdefinestyle{indentRulesGlobal}{
 style=yaml-LST,
 firstnumber=292,linerange={292-304},
 numbers=left,
}

\lstdefinestyle{modifylinebreaks}{
 style=yaml-LST,
 firstnumber=309,linerange={309-311},
 numbers=left,
}

\lstdefinestyle{textWrapOptions}{
 style=yaml-LST,
 firstnumber=345,linerange={345-346},
 numbers=left,
}

\lstdefinestyle{textWrapOptionsAll}{
 style=yaml-LST,
 firstnumber=345,linerange={345-370},
 numbers=left,
}

\lstdefinestyle{oneSentencePerLine}{
 style=yaml-LST,
 firstnumber=315,linerange={315-341},
 numbers=left,
}

\lstdefinestyle{sentencesFollow}{
 style=yaml-LST,
 firstnumber=321,linerange={321-329},
 numbers=left,
}

\lstdefinestyle{sentencesBeginWith}{
 style=yaml-LST,
 firstnumber=330,linerange={330-333},
 numbers=left,
}

\lstdefinestyle{sentencesEndWith}{
 style=yaml-LST,
 firstnumber=334,linerange={334-339},
 numbers=left,
}
...
\lstdefinestyle{modifylinebreaksEnv}{
 style=yaml-LST,
 firstnumber=380,linerange={380-389},
 numbers=left,
}

\lstdefinestyle{replacements}{
 style=yaml-LST,
 firstnumber=439,linerange={439-444},
 numbers=left,
}

\lstdefinestyle{switchesViaYaml}{
 style=yaml-LST,
 firstnumber=527,linerange={527-537},
 numbers=left,
}

\lstdefinestyle{fineTuning}{
 style=yaml-LST,
 firstnumber=447,linerange={447-522},
 numbers=left,
}

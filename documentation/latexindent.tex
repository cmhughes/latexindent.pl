...
\NewDocumentCommand{\announce}{ s m o }{%
	\IfBooleanTF{#1}
	{% \announce*
		\tcbdocmarginnote[overlay={\node at ([yshift=0mm,xshift=1mm]frame.north east) {\stardemo}; }]{\tcbdocnew{#2}}
		\addcontentsline{new}{cmhtitle}{#3}%
	}
	{% \announce
...
\lstdefinestyle{noAdditionalIndentGlobalEnv}{
	style=yaml-LST,
	firstnumber=270,linerange={270-271},
	numbers=left,
}

\lstdefinestyle{noAdditionalIndentGlobal}{
	style=yaml-LST,
	firstnumber=270,linerange={270-282},
	numbers=left,
}

\lstdefinestyle{indentRulesGlobalEnv}{
	style=yaml-LST,
	firstnumber=286,linerange={286-287},
	numbers=left,
}

\lstdefinestyle{indentRulesGlobal}{
	style=yaml-LST,
	firstnumber=286,linerange={286-298},
	numbers=left,
}
...
\lstdefinestyle{textWrapOptions}{
	style=yaml-LST,
	firstnumber=382,linerange={382-383},
	numbers=left,
}
...
\lstdefinestyle{removeParagraphLineBreaks}{
	style=yaml-LST,
	firstnumber=385,linerange={385-397},
	numbers=left,
}

\lstdefinestyle{paragraphsStopAt}{
	style=yaml-LST,
	firstnumber=398,linerange={398-406},
	numbers=left,
}

\lstdefinestyle{modifylinebreaksEnv}{
	style=yaml-LST,
	firstnumber=407,linerange={407-416},
	numbers=left,
}

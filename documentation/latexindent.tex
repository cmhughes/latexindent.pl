...
\NewDocumentCommand{\announce}{ s m s o }{%
	\IfBooleanTF{#1}
	{% \announce*
		...
		\addcontentsline{new}{cmhtitle}{#4}%
	}
	{% \announce
		\tcbdocmarginnote{%
			\IfBooleanTF{#3}
...
\lstdefinestyle{commandCodeBlocks}{
	style=yaml-LST,
	firstnumber=301,linerange={301-311},
	numbers=left,
}

\lstdefinestyle{modifylinebreaks}{
	style=yaml-LST,
	firstnumber=381,linerange={381-383},
	numbers=left,
}

\lstdefinestyle{textWrapOptions}{
	style=yaml-LST,
	firstnumber=384,linerange={384-385},
	numbers=left,
}

\lstdefinestyle{textWrapOptionsAll}{
	style=yaml-LST,
	firstnumber=384,linerange={384-386},
	numbers=left,
}

\lstdefinestyle{removeParagraphLineBreaks}{
	style=yaml-LST,
	firstnumber=387,linerange={387-399},
	numbers=left,
}
...
\lstdefinestyle{modifylinebreaksEnv}{
	style=yaml-LST,
	firstnumber=409,linerange={409-418},
	numbers=left,
}

...
Before you start using it, bear in mind that \lstinline!indent.pl! has the option to overwrite your \lstinline!.tex! files.
...
that \lstinline!indent.pl! is just following its instincts-- there is nothing 
particular about these commands.
...
\begin{itemize}
	...
	can \emph{remove} all indendation by setting \lstinline!defaultIndent: ""!

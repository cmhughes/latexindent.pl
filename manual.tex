...
The \lstinline!yaml!-based interface of \lstinline!indent.plx! was inspired 
...
have to make a GUI for \lstinline!indent.plx!, but the release of \lstinline!arara! 
...
out on the sample files that come with it. 
...
\begin{itemize}
    ...
    Note that if \lstinline!indent.plx! can not create the backup, then it 
...
\begin{itemize}
	...
	\emph{As long as you leave this switch on (set to 1) you don't need to specify which 
      ...
      \item[\lstinline!indentAfterDocument!] 0

        This switch tells \lstinline!indent.plx! to indent after \lstinline!\end{document}! 
        or not.

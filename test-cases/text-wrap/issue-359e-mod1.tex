\begin{abstract}
    ...
    \begin{another}
        Another is a very long sentence that should be wrapped at some point, which is the case
        ...
        \begin{itemize}
            ...
            \item
                  ...
                  \begin{itemize}
                      \item
                            One is a very long sentence that should be wrapped at some point,
                            which is the case but is is is is line width is not respected because
                            of the indentation.
                      \item
                            Two is a very long sentence that should be wrapped at some point,
                            which is the case but is is is is line width is not respected because
                            of the indentation.
                  \end{itemize}
            \item

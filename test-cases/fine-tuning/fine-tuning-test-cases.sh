...
latexindent.pl -s -t commands1 -o=+-mod1 -l=fine-tuning-commands1.yaml
egrep 'found:' indent.log > commands1-mod1.txt

# key equals value
latexindent.pl -s keyequalsvalue1 -o=+-mod0
latexindent.pl -s -t keyequalsvalue1 -o=+-mod1 -l=fine-tuning-keyequalsvalue1.yaml
egrep 'found:' indent.log > keyequalsvalue1-mod1.txt
latexindent.pl -s -t keyequalsvalue1 -o=+-mod2 -l=fine-tuning-keyequalsvalue2.yaml

# named braces brackets
latexindent.pl -s namedbracketsbraces1 -o=+-mod0
latexindent.pl -s -t namedbracketsbraces1 -o=+-mod1 -l=fine-tuning-namedbracketsbraces1.yaml
egrep 'found:' indent.log > namedbracketsbraces1-mod1.txt
latexindent.pl -s namedbracketsbraces1 -o=+-mod2 -l=fine-tuning-namedbracketsbraces2.yaml

# unnamed braces brackets
latexindent.pl -s unnamedbracesbrackets1 -o=+-mod0 -l=fine-tuning-unnamed
latexindent.pl -s unnamedbracesbrackets1 -o=+-mod1 -l=fine-tuning-unnamed1.yaml

# arguments
latexindent.pl -s arguments1 -o=+-mod0
latexindent.pl -s -t arguments1 -o=+-mod1 -l=fine-tuning-args1.yaml

latexindent.pl -s arguments2 -o=+-mod0
latexindent.pl -s -t arguments2 -o=+-mod2 -l=fine-tuning-args2.yaml

...
If your course came with problem sets that you would like to import\footnote{Of course, these may have an ordering that is not in line with your syllabus.
	...
	So it might be worth importing them and learning how to modify these sets to meet your own needs.}, you may wish to skip ahead to the \hyperref[imp]{section on importing assignments}.
...
This creates a \texttt{.def} file containing the list of problems, how many attempts you chose, etc.

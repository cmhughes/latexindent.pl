...
\end{commandshell} given in \cref{lst:tikz-node1-no-strings}.
	...
	\announce{new}*{amalgamate feature in commandCodeBlocks}, we see that the first field in the \texttt{stringsAllowedBetweenArguments} is \texttt{amalgamate} and is set to \texttt{1} by default.
	%

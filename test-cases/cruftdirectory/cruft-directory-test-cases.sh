...
latexindent.pl -s  -tt cruft-directory1  -w -l=cycleThroughBackUps.yaml -g=four.log 
latexindent.pl -s  -tt cruft-directory1  -w -l=cycleThroughBackUps.yaml,noCycle.yaml -g=five.log 
git status

...
do 
   ...
   [[ $silentMode == 0 ]] && set -x 
   # one mand arg
   latexindent.pl environments-first-mand-args.tex -m  -tt -s -o=environments-first-mand-args-mod$i.tex -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml 
   latexindent.pl environments-first-mand-args.tex -m  -tt -s -o=environments-first-mand-args-mod-supp$i.tex -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml,mand-args-supp.yaml 
   latexindent.pl environments-first-mand-args-remove-linebreaks1.tex -m  -tt -s -o=environments-first-mand-args-remove-linebreaks1-mod$i.tex -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml 
   latexindent.pl environments-first-mand-args-remove-linebreaks1.tex -m  -tt -s -o=environments-first-mand-args-remove-linebreaks1-mod-supp$i.tex -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml,mand-args-supp.yaml
   latexindent.pl environments-first-mand-args-remove-linebreaks2.tex -m  -tt -s -o=environments-first-mand-args-remove-linebreaks2-mod-supp$i.tex -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml,unprotect-blank-lines.yaml
   # two mand args
   latexindent.pl environments-second-mand-args.tex -m -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml -tt -s -o=environments-second-mand-args-mod$i.tex 
   latexindent.pl environments-second-mand-args-remove-linebreaks1.tex -m -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml -tt -s -o=environments-second-mand-args-remove-linebreaks1-mod$i.tex 
   latexindent.pl environments-second-mand-args-remove-linebreaks1.tex -m -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml,unprotect-blank-lines.yaml -tt -s -o=environments-second-mand-args-remove-linebreaks1-mod-unprotect$i.tex 
   latexindent.pl environments-second-mand-args-remove-linebreaks1.tex -m -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml,unprotect-blank-lines.yaml,condense-blank-lines.yaml -tt -s -o=environments-second-mand-args-remove-linebreaks1-mod-unprotect-condense$i.tex 
   # three, ah ah ah
   latexindent.pl environments-third-mand-args-remove-linebreaks1-trailing-comments.tex -m -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml -s -tt -o=environments-third-mand-args-remove-linebreaks1-trailing-comments-mod$i.tex
   latexindent.pl environments-third-mand-args.tex -m -l=../environments/env-all-on.yaml,mand-args-mod$i.yaml,addPercentAfterBegin.yaml -tt -s -o=environments-third-mand-args-mod$i.tex -g=other.log
   [[ $silentMode == 0 ]] && set +x 
done
# multi switches set to 2
latexindent.pl environments-third-mand-args-remove-linebreaks1-trailing-comments.tex -m -l=../environments/env-all-on.yaml,mand-args-mod1.yaml,addPercentAfterBegin.yaml -s -tt -o=environments-third-mand-args-remove-linebreaks1-trailing-comments-mod1-addPercentAfterBegin.tex
...
latexindent.pl -s -tt -m -w environments-first-mand-args-mod-supp1.tex -l=../environments/env-all-on.yaml,addPercentAfterBody.yaml -o=environments-first-mand-args-mod-supp1-mod1.tex 
latexindent.pl -s environments-first-mand-args-more-comments.tex -m -l=../opt-args/opt-args-remove-all.yaml,../environments/env-all-on.yaml,addPercentAfterBegin.yaml  -tt -o=environments-first-mand-args-more-comments-addPercentAfterBegin.tex

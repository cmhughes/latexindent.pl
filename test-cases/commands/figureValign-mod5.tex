...
\NewEnviron{verticallyaligned}{%
	...
	\newlength{\vamaxheight}\setlength{\vamaxheight}{\ht\vabox}% output the body, which now contains the new height :)
...
\begin{figure}
	\begin{verticallyaligned}
		...
		\begin{minipage}[b][\vamaxheight][c]{.50\textwidth}
			\centering
			\includegraphics[width=\textwidth]{example-image}\caption{}
		\end{minipage}
		%
		\hfill

...
our @EXPORT_OK = qw/%switches storeSwitches $is_m_switch_active $is_t_switch_active $is_tt_switch_active $is_r_switch_active $is_rr_switch_active/;
our %switches;
...
sub storeSwitches{
    ...
    $is_r_switch_active = $is_rr_switch_active ? $is_rr_switch_active : $is_r_switch_active;
